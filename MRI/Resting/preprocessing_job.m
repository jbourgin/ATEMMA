...
matlabbatch{4}.spm.spatial.preproc.tissue(1).tpm = {'C:\toolbox\spm\tpm\TPM.nii,1'};
matlabbatch{4}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(1).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(1).warped = [0 1];
matlabbatch{4}.spm.spatial.preproc.tissue(2).tpm = {'C:\toolbox\spm\tpm\TPM.nii,2'};
matlabbatch{4}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(2).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(2).warped = [0 1];
matlabbatch{4}.spm.spatial.preproc.tissue(3).tpm = {'C:\toolbox\spm\tpm\TPM.nii,3'};
matlabbatch{4}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{4}.spm.spatial.preproc.tissue(3).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(3).warped = [0 1];
matlabbatch{4}.spm.spatial.preproc.tissue(4).tpm = {'C:\toolbox\spm\tpm\TPM.nii,4'};
matlabbatch{4}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{4}.spm.spatial.preproc.tissue(4).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(5).tpm = {'C:\toolbox\spm\tpm\TPM.nii,5'};
matlabbatch{4}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{4}.spm.spatial.preproc.tissue(5).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(5).warped = [0 0];
%matlabbatch{4}.spm.spatial.preproc.tissue(5).warped = [0 1];
matlabbatch{4}.spm.spatial.preproc.tissue(6).tpm = {'C:\toolbox\spm\tpm\TPM.nii,6'};
