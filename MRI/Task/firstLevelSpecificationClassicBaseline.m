...
function [matlabbatch] = firstLevelSpecificationClassicBaseline(filesList, onsetsList, rpList, statDir)
...
matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'Face > Baseline';
matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [1 1 1 -3 0 0 0 0 0 0 1 1 1 -3];
