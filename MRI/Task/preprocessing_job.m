function [matlabbatch] = preprocessing_job(filesList, anatFile, subjectDirectory)

matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_cd.dir = {subjectDirectory};
matlabbatch{2}.spm.temporal.st.scans = {filesList{1}, filesList{2}, filesList{3}, filesList{4}}';                                  
...
matlabbatch{5}.spm.spatial.normalise.estwrite.eoptions.tpm = {'C:\toolbox\spm\tpm\TPM.nii'};
...
matlabbatch{6}.spm.spatial.normalise.write.subj.resample(3) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 3)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{3}, '.','rfiles'));
matlabbatch{6}.spm.spatial.normalise.write.subj.resample(4) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 4)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{4}, '.','rfiles'));
