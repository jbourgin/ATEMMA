...
function [matlabbatch] = firstLevelSpecificationClassicEye(filesList, onsetsList, rpList, statDir)
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [0 0 0 1 0 0 0 0 0 zeros(1,nzeros) 0 0 0 1 0 0 0 0 0];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Anger';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [1 0 0 0 0 0 0 0 0 zeros(1,nzeros) 1 0 0 0 0 0 0 0 0];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Neutral';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0 0 0 0 0 0 1 0 0 zeros(1,nzeros) 0 0 0 0 0 0 1 0 0];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'Emotion_Classic > Neutre_Classic';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [1 0 0 1 0 0 -2 0 0 zeros(1,nzeros) 1 0 0 1 0 0 -2 0 0];
matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'Fear_Classic > Neutre_Classic';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [0 0 0 1 0 0 -1 0 0 zeros(1,nzeros) 0 0 0 1 0 0 -1 0 0];
matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'Angry_Classic > Neutre_Classic';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [1 0 0 0 0 0 -1 0 0 zeros(1,nzeros) 1 0 0 0 0 0 -1 0 0];
matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'Increasing Fix Angry';
matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [0 1 0 0 0 0 0 0 0 zeros(1,nzeros) 0 1 0 0 0 0 0 0 0];
matlabbatch{3}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{8}.tcon.name = 'Increasing Fix Fear';
matlabbatch{3}.spm.stats.con.consess{8}.tcon.weights = [0 0 0 0 1 0 0 0 0 zeros(1,nzeros) 0 0 0 0 1 0 0 0 0];
matlabbatch{3}.spm.stats.con.consess{8}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{9}.tcon.name = 'Increasing Fix Neutral';
matlabbatch{3}.spm.stats.con.consess{9}.tcon.weights = [0 0 0 0 0 0 0 1 0 zeros(1,nzeros) 0 0 0 0 0 0 0 1 0];
matlabbatch{3}.spm.stats.con.consess{9}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{10}.tcon.name = 'Increasing Fix All';
matlabbatch{3}.spm.stats.con.consess{10}.tcon.weights = [0 1 0 0 1 0 0 1 0 zeros(1,nzeros) 0 1 0 0 1 0 0 1 0];
